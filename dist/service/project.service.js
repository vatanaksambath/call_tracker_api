...
let ProjectService = class ProjectService {
    ...
    async projectPagination(commonDTO, userId) {
        const parameters = [commonDTO.page_number, commonDTO.page_size, commonDTO.search_type, commonDTO.query_search];
        try {
            const result = await this.call_tracker.query(query_common_1.SQL.projectPagination, parameters);
            return result;
        }
        catch (error) {
    ...
    async createProject(projectDTO, userId) {
        ...
        try {
            const result = await this.call_tracker.query(query_common_1.SQL.projectInsert, parameters);
            return result;
        }
        catch (error) {
            throw new Error(error);
    ...
    async updateProject(projectDTO, userId) {
        ...
        try {
            const result = await this.call_tracker.query(query_common_1.SQL.projectUpdate, parameters);
            return result;
        }
        catch (error) {
            throw new Error(error);
    ...
    async deleteProject(id) {
        try {
            const result = await this.call_tracker.query(query_common_1.SQL.projectDelete, [id]);
            return result;
        }
        catch (error) {
            throw new Error(error);
