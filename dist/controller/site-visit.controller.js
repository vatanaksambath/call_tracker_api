...
const site_visit_dto_1 = require("../dataModel/site-visit.dto");
...
__decorate([
    ...
    (0, permission_decorator_1.RequirePermission)('MU_03', 'PM_02'),
...
], SiteVisitController.prototype, "get", null);
__decorate([
    (0, common_1.UseGuards)(permission_guard_1.PermissionGuard),
    (0, permission_decorator_1.RequirePermission)('MU_03', 'PM_01'),
    (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
    ...
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [site_visit_dto_1.SiteVisitDTO, Object]),
    __metadata("design:returntype", Promise)
], SiteVisitController.prototype, "create", null);
__decorate([
    (0, common_1.UseGuards)(permission_guard_1.PermissionGuard),
    (0, permission_decorator_1.RequirePermission)('MU_03', 'PM_03'),
    (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
    ...
    __metadata("design:paramtypes", [site_visit_dto_1.SiteVisitDTO, Object]),
    __metadata("design:returntype", Promise)
], SiteVisitController.prototype, "update", null);
__decorate([
    (0, common_1.UseGuards)(permission_guard_1.PermissionGuard),
    (0, permission_decorator_1.RequirePermission)('MU_03', 'PM_04'),
    (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
    ...
    __metadata("design:returntype", Promise)
], SiteVisitController.prototype, "delete", null);
exports.SiteVisitController = SiteVisitController = __decorate([
    (0, common_1.Controller)('site-visit'),
